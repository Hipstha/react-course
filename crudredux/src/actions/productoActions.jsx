...
const agregarProducto = () => ({
  type: AGREAGAR_PRODUCTO,
  payload: true
})

// si el producto sr guarda en la base de datos
...
// función que descarga producrtos de la base de datos
...
// eidta un registro en la pai y state
